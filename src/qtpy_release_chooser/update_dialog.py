...
from qtpy_release_chooser.config import LOCAL_PROGRAM_INFO, is_remote_version_newer, toolset_tag_to_version
from qtpy_release_chooser.update_github import (
    fetch_and_cache_forks,
    fetch_fork_releases,
    filter_releases,
)
from qtpy_release_chooser.update_process import start_update_process
...
if TYPE_CHECKING:
    ...
    from github_app_updater.github import Asset, GithubRelease
...
class UpdateDialog(QDialog):
    ...
    def init_config(self):
        ...
        self.forks_cache["bodencrouch/PyKotor"] = fetch_fork_releases(
    ...
    def start_update(self, release: GithubRelease):
        ...
        if not asset:
            from qtpy_release_chooser.config import translate as tr, trf
