...
from qtpy_release_chooser.config import (
    LOCAL_PROGRAM_INFO,
    is_remote_version_newer,
    toolset_tag_to_version,
    version_to_toolset_tag,
)
from qtpy_release_chooser.config import translate as tr
from qtpy_release_chooser.progress import ProgressDialog
from qtpy_release_chooser._arch import ProcessorArchitecture
from qtpy_release_chooser._shutdown import terminate_child_processes
from github_app_updater.github import GithubRelease
from github_app_updater.update import AppUpdate

if TYPE_CHECKING:
    from qtpy.QtGui import QIcon
    from qtpy.QtWidgets import QWidget

    from github_app_updater.github import Asset
...
class UpdateDialog(QDialog):
    ...
    def init_config(self):
        ...
        self.forks_cache["bodencrouch/PyKotor"] = self.fetch_fork_releases(
            "bodencrouch/PyKotor", include_all=True
        )
    ...
    def fetch_and_cache_forks_with_releases(self):
        ...
        forks_url = "https://api.github.com/repos/bodencrouch/PyKotor/forks"
        if requests is None:
    ...
    def populate_fork_combo_box(self):
        ...
        self.ui.forkComboBox.addItem("bodencrouch/PyKotor")
    ...
    def start_update(
        ...
        if asset:
            ...
            # TODO(bodencrouch): compile from src.
